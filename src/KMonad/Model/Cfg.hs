...
instance Semigroup PCfg where
  PCfg is os cks csds km fts acs ksd ias <> PCfg is' os' cks' csds' km' fts' acs' ksd' ias' =
    PCfg (is ++ is') (os ++ os') (cks ++ cks') (csds ++ csds') (km ++ km') (fts ++ fts') (acs ++ acs') (ksd ++ ksd') (ias ++ ias')
